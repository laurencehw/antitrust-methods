...
Merger review evaluates a prospective transaction. Monopolization cases instead reconstruct historical patterns of behavior and ask whether a dominant firm has maintained or extended its position through exclusionary means rather than competition on the merits. Section 2 of the Sherman Act in the United States and Article 102 of the Treaty on the Functioning of the European Union (TFEU) frame the legal standards, but enforcement priorities and evidentiary approaches differ substantially across jurisdictions.

This chapter sets out a workflow for analyzing monopolization claims. It begins with market power assessment, drawing on tools from @sec-market-definition and @sec-io-toolkit. It then turns to specific conduct categories: predation, rebates and loyalty programs, tying and bundling, most-favored-nation clauses, vertical restraints, and refusal to deal. For each, theoretical mechanisms pair with empirical measurement strategies and qualitative evidence. The chapter closes with remedy design and case exemplars showing how different jurisdictions approach the same exclusionary practices.

The code boxes compute effective prices and assess foreclosure shares. The qualitative evidence boxes point to the documentary and testimonial sources that complement them. Case boxes draw on decisions from the United States, European Union, and Southern Africa.
