...
The exclusionary conduct frameworks in this chapter also apply directly to **Chapter 9 (Digital Markets)**, where platform self-preferencing, default tying, and data leverage cases build on the same analytical foundations. Store your foreclosure share calculations, effective price templates, and event study code in `data/derived/` so they can be adapted for platform-specific applications.
