...
For empirical evidence on labor market concentration, see @azar_etal_2020, who found average labor market HHI exceeding 3,100 using Burning Glass online vacancy data, and @benmelech_bergman_kim_2020, who documented similar patterns using plant-level data from the Census Bureau's Longitudinal Business Database. Both studies confirm that labor market concentration is pervasive and that it correlates with lower wages, reduced job mobility, and higher inequality.
...
#| fig-cap: "Labor supply elasticity estimation. Synthetic data for illustration only."
#| message: false
#| warning: false
library(fixest)
library(dplyr)
...
#| fig-cap: "Noncompete enforcement difference-in-differences. Synthetic data for illustration only."
#| message: false
#| warning: false
library(dplyr)
library(fixest)
...
The enforcement framework was built in stages. The DOJ and FTC's 2016 guidance for HR professionals [@doj_hr_guidance_2016] marked the turning point: it was the first announcement that "naked" wage-fixing and no-poach agreements---those not ancillary to a legitimate collaboration such as a joint venture---would be prosecuted criminally, on par with price-fixing cartels, a significant escalation from the prior practice of civil settlements and consent orders. The operative framework is now the January 2025 *Antitrust Guidelines for Business Activities Affecting Workers* [@doj_ftc_worker_guidelines_2025], which superseded the 2016 guidance: the 2025 Guidelines restate the criminal treatment of naked wage-fixing and no-poach agreements and set out the agencies' civil theories on compensation-information sharing, noncompete terms, and restraints in franchise and staffing arrangements. On the merger side, Guideline 10 of the 2023 Merger Guidelines directs the agencies to assess whether a transaction may substantially lessen competition for workers, using the concentration and elasticity evidence this chapter develops [@doj_ftc_hmg_2023].
...
**Healthcare concentration and monopsony.** The Health Market Inquiry (2014--2019) found that Netcare, Mediclinic, and Life Healthcare collectively controlled over 80% of private hospital beds and 90% of admissions, a degree of concentration that enabled sustained above-competitive pricing for facility fees [@sa_hmi_2019]. The inquiry concluded in 2019 and was framed around facility prices and over-servicing, not wages. But the labor-market implication follows from the structure it documented: the same three groups that dominate private hospital capacity are, in many local markets, the dominant buyers of nursing and other clinical labor---the structural monopsony conditions this chapter has been measuring. The inquiry's central recommendation, supply-side regulation through a dedicated health-sector regulator, would reach that buyer power only indirectly. For labor antitrust, the HMI's value is its evidence base: bed-share and admissions data of the kind a monopsony analysis of South African nursing labor would build on.
...
Labor antitrust connects to several threads in the remaining chapters. **@sec-innovation-ip** takes up how employment contracts, particularly noncompete clauses and trade secret provisions, interact with innovation incentives. The same monopsony frameworks apply when labor market restrictions affect the pace of technical change.
