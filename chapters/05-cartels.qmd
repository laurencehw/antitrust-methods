...
## Looking ahead
The detection screens, overcharge regressions, and pass-through analyses developed here carry forward throughout the book. **Chapter 6 (Mergers)** builds on the same demand estimates and diversion ratios---post-cartel mergers frequently face heightened scrutiny, and the diagnostic tools overlap substantially. **Chapter 12 (Litigation Practice)** revisits damages modeling and expert report preparation, showing how to package cartel evidence for courtroom presentation. The rotation indices, structural break plots, and overcharge tables introduced here will serve as templates you can adapt to new cases and jurisdictions.
