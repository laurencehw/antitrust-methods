...
## Looking ahead
The demand estimates, diversion matrices, and pass-through diagnostics introduced here form the quantitative backbone of the chapters ahead. In **Chapter 5 (Cartels)**, we apply variance screens and structural break tests to detect collusion, while in **Chapter 6 (Mergers)** we feed these IO primitives directly into merger simulations. The same bargaining and pass-through tools reappear in **Chapter 7 (Monopolization)** and **Chapter 9 (Digital Markets)**, where multi-sided platform dynamics add further complexity.
