...
This chapter occupies a pivotal position in the book. The demand models, cost estimates, and bargaining frameworks introduced here feed directly into the merger simulations in @sec-mergers, the exclusionary conduct analysis in @sec-monopolization, and the digital markets analysis in @sec-digital-markets. Master these tools, and you will be equipped to tackle nearly any quantitative antitrust question.
