...
Much of the rest of the book runs through this chapter. The demand models, cost estimates, and bargaining frameworks here feed the merger simulations in @sec-mergers, the foreclosure analysis in @sec-monopolization, and the platform work in @sec-digital-markets. The investment pays off across all of them.
