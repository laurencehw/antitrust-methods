...
The preceding chapters focused on diagnosing competitive harm---identifying cartels (@sec-cartels), predicting merger effects (@sec-mergers), and establishing exclusionary conduct (@sec-monopolization). But identifying harm is only half the job. This chapter addresses what comes next: designing remedies that actually work and, in some cases, ongoing regulatory frameworks that substitute for competition where markets cannot be made competitive.
