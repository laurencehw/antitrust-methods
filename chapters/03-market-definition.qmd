...
The workflow says *what* to do; the diagnostics below show *how*. Each produces artifacts that feed directly into merger simulations (@sec-mergers) and cartel analysis (@sec-cartels):
