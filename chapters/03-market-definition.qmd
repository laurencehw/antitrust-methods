...
# Select top 30 routes by volume for visualization clarity
...
p_heatmap <- ggplot(route_shares_top, aes(x = carrier, y = route_labeled, fill = share)) +
  ...
  labs(
    ...
    subtitle = "Top 30 routes by volume. HHI values indicate market concentration (>2,500 = highly concentrated)",
    x = "Carrier",
