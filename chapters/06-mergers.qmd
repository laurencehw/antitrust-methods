...
Hospital mergers are among the most actively litigated in US antitrust, with the FTC challenging roughly one per year. Commercial insurance prices can rise 20--40% after consummation of anticompetitive hospital mergers, as documented in retrospective studies [@dafny_2009; @gaynor_town_2012]. The analytical framework combines differentiated-products merger analysis (hospitals compete on quality, location, and reputation) with bilateral bargaining models, because hospitals negotiate rates with insurers rather than individual patients. The UPP/simulation toolkit from this chapter applies, with one wrinkle: the "price" is not set in a standard posted-price market.
