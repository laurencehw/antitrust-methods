...
Antitrust damages quantify the difference between what actually happened and what would have happened absent the anticompetitive conduct---the "but-for world" [@baker_rubinfeld_1999]. Constructing a credible but-for scenario is the central challenge, and courts have developed a rich body of law evaluating competing damages models. The three foundational approaches are before/after, yardstick, and difference-in-differences, each exploiting different sources of variation to identify the counterfactual.
