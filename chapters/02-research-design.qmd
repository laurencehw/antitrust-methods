...
For a practical guide to these methods, we rely on **"Causal Inference: The Mixtape"** (Cunningham, 2021). It bridges the gap between textbook theory and coding reality.
-   **Start here:** [mixtape.scunning.com](https://mixtape.scunning.com/) (Chapters on DAGs and DiD).
-   **Context:** To understand how these methods displaced earlier approaches, see Angrist & Pischke (2010), "The Credibility Revolution in Empirical Economics" ([AEA link](https://www.aeaweb.org/articles?id=10.1257/jep.24.2.3)).
:::
