...
Diagnosing harm is only half the job. The cartel, merger, and monopolization chapters were about establishing that competition had been hurt, or would be. This chapter is about what you do once you have: designing a remedy that actually works, and---where a market cannot be made competitive at all---standing regulation in for competition.
...
Merger guidelines in major jurisdictions discuss both structural and behavioral remedies (DOJ/FTC Merger Guidelines, 2023); (CMA Merger Assessment Guidelines, 2021); (EC Horizontal Merger Guidelines, 2004); the horizontal merger framework in [Chapter 6](chapters/06-mergers.md) provides the diagnostic tools that inform remedy selection. Vertical mergers, covered separately by (DOJ/FTC Vertical Merger Guidelines, 2020), often raise remedy design questions involving access and non-discrimination commitments rather than divestitures. The choice between structural and behavioral remedies depends on the diagnosed harm, the feasibility of monitoring, and the institutional capacity of the enforcing agency.
...
**Behavioral (or conduct) remedies**---access commitments, most-favored-nation (MFN) bans, parity obligations, algorithm transparency requirements, firewall provisions, and anti-retaliation clauses---are more common in vertical merger cases and in abuse-of-dominance proceedings where the competitive concern relates to foreclosure or discrimination rather than the elimination of a direct rival. The consent decree in (*United States v. Microsoft*, 2001) is a canonical example: rather than breaking up Microsoft, the final judgment imposed interoperability and non-discrimination obligations that required sustained monitoring over a decade-long compliance period. The underlying monopolization theory is analyzed in [Chapter 7](chapters/07-monopolization.md). Behavioral remedies offer flexibility, since they can be tailored to specific theories of harm without the disruption of asset sales, but they impose significant monitoring costs on the enforcing agency. The compliance trustee must verify adherence, interpret ambiguous provisions, and respond to complaints from rivals who may have incentives to game the process. These challenges have led the FTC's Bureau of Competition to express skepticism about behavioral remedies in several retrospective studies, finding that conduct conditions in merger settlements have a mixed track record: some succeed in preserving competition, while others are evaded through creative compliance or become obsolete as market conditions evolve.
...
{% hint style="info" %}
**Case box: AT&T/Time Warner --- The limits of behavioral remedies in vertical mergers**
...
South Africa's proposed Supply-Side Regulator for Health takes a fundamentally different approach to the hospital market power problem: instead of case-by-case merger review, it would impose ongoing benchmarking and price regulation across the private hospital sector. The analytical tools from this chapter, cost benchmarking and incentive regulation, would apply directly to such a regulator's operations. The open question is whether a developing country's regulatory apparatus can sustain the data collection, technical capacity, and institutional independence that health sector regulation demands. International experience from the NHS in the UK (Monitor/NHS Improvement) and the German hospital planning system suggests that health sector regulation requires substantial investment in data infrastructure and clinical expertise within the regulatory body. Cross-reference [Chapter 10](chapters/10-labor-markets.md) for related concerns about healthcare labor market concentration, which compounds the product-market power issues discussed here.
...
A regulated utility has a rate base of $1,000 million, an allowed rate of return of 8%, annual operating expenses of $50 million, and annual depreciation of $30 million.

a. Using Revenue = (Rate base x Allowed return) + Opex + Depreciation, compute the allowed revenue requirement.
b. Name the incentive problem this cost-plus structure creates.

{% hint style="success" %}
**Worked answer**

a. Revenue = (1,000 x 0.08) + 50 + 30 = 80 + 50 + 30 = **$160 million**.
b. The **Averch-Johnson effect**: because the firm earns a return on its rate base, it has an incentive to over-invest in capital ("gold-plating") whenever the allowed return exceeds its true cost of capital.
{% endhint %}

## Looking ahead
The remedy design and evaluation tools here carry into the next chapters. [Chapter 9](chapters/09-digital-markets.md) applies access mandates, fair-ranking obligations, and interoperability remedies to platform markets, obligations codified in instruments such as the EU Digital Markets Act (Digital Markets Act, 2022), where behavioral remedies and ongoing monitoring matter most. [Chapter 12](chapters/12-litigation-practice.md) covers how to present remedy compliance evidence in expert reports and how retrospective evaluations feed into damages proceedings. As you encounter new cases, ask which remedy type---structural, behavioral, or hybrid---best matches the diagnosed harm, and how the benchmarking and diff-in-diff frameworks here can test whether it is working.
