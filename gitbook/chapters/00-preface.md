...
A distinctive feature of this book is its tri-jurisdictional approach, drawing consistently on antitrust law and practice in the United States, the European Union, and South Africa. US coverage includes the Department of Justice Antitrust Division, the Federal Trade Commission, and federal courts. EU coverage addresses the European Commission and the distinct standards that shape competition enforcement across member states. The South African focus—centered on the Competition Commission and Competition Tribunal—serves practitioners working in developing and emerging economy competition regimes and illustrates how antitrust methods translate across different institutional contexts. Throughout the book, we highlight where these jurisdictions diverge in their standards, burdens of proof, or analytical approaches.

When a claim depends on jurisdictional context, we flag it explicitly. Readers in any jurisdiction should find the methods broadly applicable while remaining attentive to local legal frameworks.
