...
**For classroom use:** Work through chapters sequentially, starting with the orientation to antitrust institutions ([Chapter 1](chapters/01-orientation.md)) and research design ([Chapter 2](chapters/02-research-design.md)). The core analytical chapters on market definition ([Chapter 3](chapters/03-market-definition.md)), industrial organization tools ([Chapter 4](chapters/04-io-toolkit.md)), and specific practice areas (cartels, mergers, monopolization) follow logically. End with the specialized chapters on digital markets, labor, and innovation that apply these methods to emerging areas.

**For practitioners:** Use the book as a reference. Each chapter opens with learning goals and core topics, making it easy to locate relevant material. The empirical appendix ([Empirical Appendix](chapters/13-empirical-appendix.md)) provides reusable code templates and diagnostic tools that can be adapted to specific matters.
...
A defining feature of this book --- and the aspect that most distinguishes it from competing texts --- is its genuinely tri-jurisdictional scope. Most antitrust textbooks are written from a single-jurisdiction perspective, treating other regimes as footnotes or comparative appendices. This book takes a different approach: the United States, the European Union, and South Africa are treated as co-equal analytical lenses throughout every chapter.

This is not an exercise in comprehensiveness for its own sake. The three jurisdictions represent fundamentally different models of competition enforcement, and understanding how methods translate across them makes you a better analyst in any one of them. The US system --- with its dual federal agencies (DOJ Antitrust Division and FTC), federal court adjudication, and the world's most developed case law --- provides the richest doctrinal foundation and the most sophisticated econometric tradition. The European Union --- with its single Commission (DG COMP), administrative decision-making, and effects-based approach refined over two decades of merger and abuse-of-dominance enforcement --- offers the clearest articulation of how to weigh competitive effects against efficiencies and the most advanced framework for digital market regulation. South Africa --- with its Competition Commission and Competition Tribunal, its public-interest mandate embedded in the Competition Act of 1998, and its role as a model for emerging-economy regimes --- demonstrates how competition policy can address structural inequality, employment effects, and small-business participation alongside conventional consumer-welfare analysis.

When a method works differently across jurisdictions, we say so explicitly. When a case from one jurisdiction illuminates a method that applies everywhere, we use it. When the data environment differs --- US microdata versus EU case-team data rooms versus South African market inquiries --- we show how to adapt. Readers working in any single jurisdiction should find the methods directly applicable, while those operating across borders will find the comparative framework essential.
