...
3.  **"Causal Inference for the Brave and True"** (Facure Alves, 2022): Covers intermediate topics including machine-learning approaches to interference. [matheusfacure.github.io/python-causality-handbook](https://matheusfacure.github.io/python-causality-handbook/)
...
![Cumulative Abnormal Returns Around Merger Announcement](../images/research-design-merger-event-1.png)

*Airline equities vs. SPY benchmark (±30 trading days around the 2013-02-14 American Airlines/US Airways announcement).*
